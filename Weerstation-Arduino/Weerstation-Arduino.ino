...
const unsigned char Zon_bits [] PROGMEM = {
...
const unsigned char wolk_bits [] PROGMEM = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
// voor bloem
const unsigned char bloem_bits [] PROGMEM = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 
 ...
 if ( draw_state == 10  ){
  ...
  switch(draw_state) {
    ...
    case 0:
      ...
      display.setCursor(56,32);  
      display.print("nat");
      display.drawBitmap(0,15, bloem_bits, 50, 40, WHITE);
      }
      break;
      //temperatuur
    case 2:
    ...
    //regensensor
      ...
      display.setCursor(56,32);  
      display.print("Droog");
      display.drawBitmap(0,17, Zon_bits, 50, 40, WHITE);
      } 
      else {
      display.setTextSize(2);
      display.setCursor(56,32);  
      display.print("Regen");
      display.drawBitmap(0,15, wolk_bits, 50, 40, WHITE);
      }
      break;
  }
